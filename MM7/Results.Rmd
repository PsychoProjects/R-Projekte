...
fn_graphical_analysis <- function(i1_w_MW, i1_f_MW, range = c(0,1), title = ""){
  ...
  hist(i1_w_MW, breaks = range, main = "erlebnisbasiert", xlab = "Rating", col = "blue", border = "black")
  hist(i1_f_MW, breaks = range, main = "nicht erlebnisbasiert", xlab = "Rating", col = "blue", border = "black")
  par(mfrow = c(1, 1))
}
```
...
fn_wilcoxon <- function (i1_w_MW, i1_f_MW, differences) {
  ...
  # Histogramm
  hist(differences, breaks = seq(min(differences) - 0.1, max(differences) + 0.1, by = 0.1), main = "Histogramm der Differenzen", xlab = "Differenzen", ylab = "Häufigkeit", col = "blue", border = "black")
  # Boxplot
